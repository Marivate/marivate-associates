...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premier South African law firm delivering strategic counsel and exceptional advocacy to businesses, institutions, and individuals." },
      ...
      { property: "og:site_name", content: "MARIVATE & Associates" },
